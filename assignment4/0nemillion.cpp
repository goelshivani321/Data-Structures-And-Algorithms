...
const int PLACES         = 5000000;        // desired decimal places 5000
...
int main (void)
    {
        ...
        printf ("The values of a,b,c,d: ");
        mpf_out_str (stdout, 10, 100, a);
        mpf_out_str (stdout, 10, 100, b);
        mpf_out_str (stdout, 10, 100, c);
        mpf_out_str (stdout, 10, 100, d);
        putchar ('\n');
        ...
        printf ("The values of root2 is : ");
        mpf_out_str (stdout, 10, 100, root2);
        putchar ('\n');
        ...
        printf ("The values of a0 : ");
        mpf_out_str (stdout, 10, 100, a0);
        putchar ('\n');
        ...
        printf ("The values of y0 : ");
        mpf_out_str (stdout, 10, 100, y0);
        putchar ('\n');
        ...
        printf ("The values of anew : ");
        mpf_out_str (stdout, 10, 1000, anew);
        putchar ('\n');
        /*
        ...
        //gmp_fprintf(pFile, " %.*s\n", PLACES+1, "pi to 1000 places:\n");
        gmp_fprintf(pFile, "%.*Ff", 1000000, anew);

        //gmp_fprintf(pFile, " %.*s", PLACES+1, "Elapsed time: ");
        //gmp_fprintf(pFile, " %.*Z\n",  elapsedtime);
